<%-- 
    ...
    Created on : 04-jul-2017, 13:57:45
    Author     : Caterin
--%>
            ...
            <c:import url="menu.jsp"></c:import>
                ...
                <div class="container">
                    <form action="controlador.do" method="post">
                        <h3 class="center-align">Transferencia</h3>
                        <div class="row">
                    ...
                    <div class="row">
                        <div class="input-field col m6 offset-m3 s6 offset-s3">
                            <input id="usuario" name="ctaDestinatario" type="text" required>
                            <label for="usuario">Numero de cuenta del destinario</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col m6 offset-m3 s6 offset-s3">
                            <input id="usuario" name="monto" type="text" required>
                            <label for="usuario">Monto a transferir</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col m6 offset-m3 s6 offset-s3">
                            <input id="usuario" name="clave" type="password" required>
                            <label for="usuario">Clave de transferencia</label>
                        </div>
                    </div>
                    <div class="row">
                        <div class="input-field col m6 offset-m3 s6 offset-s3 ">
                            <button type="submit" name="bt" value="transferirMonto" class="btn waves-effect waves-purple right">
                                Transferir
                            </button>
                        </div>
                    </div>
